...
void DrawIcon(void)
{
	...
	{
		draw_bitmap( (96-64)/2, (64-64)/2, 64, 64, gImage_line);
	}
}
...
{	
	 ...
	 {
		DrawUI_Bitmap( 0+2+2, 126, 16,24,Font_16x24[hour/10],0xFFFF,0x0000);
		DrawUI_Bitmap(16+2+2, 126, 16,24,Font_16x24[hour%10],0xFFFF,0x0000);
		DrawUI_Bitmap(32+2-2+2, 126, 16,24,Font_16x24[10],0xFFFF,0x0000);
		DrawUI_Bitmap(44+2-4+2, 126, 16,24,Font_16x24[minute/10],0xFFFF,0x0000);
		DrawUI_Bitmap(60+2-4+2, 126, 16,24,Font_16x24[minute%10],0xFFFF,0x0000);	 		 
	 }
}	
...
{   
	...
	if ( config.showFlag++ & 0x1 )
	{
		DrawUI_Bitmap_Ex( 4,(160-72)/2,72,72,BMP_findme,0X77E0);
	}
